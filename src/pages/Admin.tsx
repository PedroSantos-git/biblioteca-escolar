import { Mail, ShieldPlus, UserCog } from 'lucide-react'
...
export function Admin() {
  ...
  return (
    <div>
      <PageHeader title="Administração" subtitle="Gere quem tem acesso de operador à aplicação." />
            ...
            <tbody>
              {operadores.map((o) => (
                <tr key={o.id} className="border-b border-slate-50 transition-colors last:border-0 hover:bg-slate-50/80">
                  <td className="px-5 py-3.5 font-medium text-slate-800">{o.nome}</td>
